...
A(f'''<div class="two">
  <div class="intro">
    ...
    <div class="body">
      ...
      <p>في الدرس اللي فات اتكلمنا عن حماية <b>الاتصال والحسابات</b> باستخدام <b>التشفير والمصادقة</b>.</p>
      <p>لكن تخيل مؤسسة عندها <b>شبكة كاملة</b>… هل ينفع تعتمد على <b>وسيلة حماية واحدة بس</b>؟ أكيد لا.</p>
      <p>لو طبقة حماية فشلت، تفضل <b>طبقات تانية شغالة</b> تقلل الخطر وتحدّ من أثر الاختراق. وده ببساطة هو مبدأ <b>الدفاع في العمق</b>.</p>
      <p>وفي نفس الوقت، مجرد إن جهاز أو مستخدم دخل الشبكة <b>مش معناه إننا نثق فيه تلقائيًا</b>؛ قبل ما نوصّله لمورد معين لازم نتحقق من <b>هويته وصلاحياته والسياق</b>. ودي فكرة <b>نهج انعدام الثقة</b>.</p>
      <p>في الدرس ده هنشوف إزاي بنستخدم حاجات زي <b>جدار الحماية</b> و<bdi>DMZ</bdi> و<bdi>VPN</bdi> و<b>ضوابط الأجهزة الطرفية</b> عشان نبني شبكة أكثر أمانًا.</p>
    </div>
    <div class="foot"><span class="pill-dark">يلا نبدأ من جدار الحماية</span></div>
  </div>
  <div class="goals">
    <h3>أهداف التعلم</h3>
...
A(f'''<div class="map m2">
  ...
  <div class="cell c2"><h4><span class="mn">3</span>الطبقات الأربع في نموذج الدرس</h4><ul>
...
A('<div class="note-line"><span class="tag">للفهم</span><span class="lead">تخيّله</span><b>بوّاب معاه قائمة</b>: كل اتصال جاي أو رايح بيتقاس على <b>قواعد محددة مسبقًا</b> — مسموح ولا ممنوع. ومكانه مش لازم يكون <b>على حدود الشبكة</b> بس؛ ممكن يكون <b>بين أجزائها</b> أو <b>على جهاز واحد</b>.</div>')
...
A(f'''<div class="fig vpu keep">{FXA}
  ...
  <div class="cap">الاستخدامين الرئيسيين — والفرق على شبكة عامة. (الخطر «بيقل»، مش بيختفي.)</div>
</div>''')
...
A(f'<div class="note-line"><span class="tag">للفهم</span><span class="lead">النقطة المهمة</span>{nw("DMZ")} بتساعد على <b>«تقليل احتمال»</b> وصول الهجوم للشبكة الداخلية — مش <b>«تمنعه»</b>. وكمان {nw("DMZ")} <b>مش</b> نظام بيعرّض <b>جميع</b> الخوادم للخارج — بس الخوادم <b>المواجهة للجمهور</b>.</div>')
...
A(f'<div class="fig flx keep">{FXA}<div class="dyh">طب لو حاجة فشلت؟ — الطبقات التانية لسه شغالة</div>'
  ...
  + '<div class="cap">أمثلة للتوضيح على بنك — الطبقات «تقلل» الخطر، مش «تمنع منعًا مطلقًا».</div></div>')
A('<div class="note-line"><span class="tag">للفهم</span><span class="lead">ليه طبقات مش حاجز واحد؟</span>لو عندك <b>حاجز واحد</b> وفشل، <b>الطريق يبقى مفتوح</b>. لكن لو الإجراءات <b>مكدّسة</b>، فشل طبقة <b>مابيوصّلش المهاجم للهدف على طول</b>: الطبقات التانية بتفضل شغالة وبتساعد على <b>تقليل الخطر والحد من أثر الاختراق</b>.</div>')
...
A('<div class="box white split"><h3>نموذج إجابة مقترح لسؤال الـ' + num("6") + ' درجات</h3>'
  ...
  + '<div class="tip"><span class="l">خد بالك في الامتحان:</span> التلميح سأل عن <b>ما يحدث إذا تم اختراق أحد الإجراءات</b> – فخلّي في إجابتك <b>مثال واضح لفشل إحدى وسائل الحماية</b>، مع توضيح <b>دور الطبقات الأخرى</b> في تقليل أثره. واذكر إن الطبقات <b>تقلل</b> الخطر ولا تمنعه منعًا مطلقًا.</div></div>')
...
A('<div class="tip"><span class="l">خد بالك في الامتحان:</span> الإجابة القوية فيها 3 حاجات: <b>(1)</b> تذكر <b>دور كل ضابط</b> من الأربعة · <b>(2)</b> توضّح ليه <b>المحيط الأمني وحده</b> مبقاش كفاية (السحابة والعمل عن بُعد) · <b>(3)</b> تقفل بإن الطبقات <b>بتقلل الخطر وبتحدّ من الأثر</b> — مش ضمان مطلق.</div>')
...
A(f'''<div class="box plain keep">
  ...
  <p>في السيناريو ده، تصميم مناسب ممكن يكون: الموقع في <b>{nw("DMZ")}</b>، وسيرفر الدرجات <b>جوّه</b>، و<b>جدار حماية</b> بينهم، والمدرسين بيدخلوا من البيت عبر <b>{nw("VPN")}</b>، وأجهزتهم عليها <b>مكافحة فيروسات ونظام محدّث</b>. وبعد كل ده: <b>كل طلب وصول للدرجات بيتفحص</b> – مش لأن الجهاز جوّه الشبكة يبقى ماشي.</p>
  <p><b>والنقطة المهمة:</b> التصميم ده <b>بيقلل</b> الخطر؛ يبقى <b>«من غير المرجح»</b> إن خرق واحد يكشف النظام كله – مش «مستحيل».</p>
</div>''')
A(f'''<div class="dark keep">
  ...
  <div class="g2">
    ...
    <ul>
      ...
      <li><b>الطبقات الأربع في نموذج الدرس:</b> مدخل الشبكة · مسار الاتصال · وضع الخوادم · الأجهزة الطرفية.</li>
...
A('''<div class="check keep kwn">
  ...
  <div class="g2">
    <ul>
      ...
      <li><span>أعرف إن الطبقات <b>تقلل</b> الخطر، وإن كشف النظام كله بخرق واحد «<b>من غير المرجح</b>» مش «مستحيل».</span></li>
    </ul>
    <ul>
      <li><span>أعرف تعريف <b>VPN</b> و<b>استخدامَيها</b>، وليه بتقلل التنصت على شبكة عامة.</span></li>
      <li><span>أقدر أذكر <b>الطبقات الأربع في نموذج الدرس</b> و<b>مثال إجراء</b> في كل طبقة.</span></li>
